...
#define WIFI_LED_PIN 19 // Pin for WiFi LED indicator
...
BH1750FVI lightMeter(0x23);  // Address of BH1750
...
void setup() {
  ...
  lightMeter.begin();
  lightMeter.setContHighRes();  // Set to high resolution mode
...
void setupWiFi() {
  digitalWrite(WIFI_LED_PIN, LOW); // Turn off LED before starting connection attempt
  Serial.print("Connecting to ");
  Serial.println(ssid);

  WiFi.begin(ssid, password);

  // Blink the LED rapidly while connecting
  ...
  // Connection successful, turn LED on
  digitalWrite(WIFI_LED_PIN, HIGH);
